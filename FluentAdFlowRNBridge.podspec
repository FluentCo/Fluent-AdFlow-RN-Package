Pod::Spec.new do |s|
  ...
  s.description      = 'Pre-built xcframework for React Native 0.79.x. Use the git tag matching your RN minor version.'
  ...
  s.source           = { :http => 'https://mobile-sdk.adflow-prod.minionplatform.com/ios-rn/v4.1.1-beta.1-rn0.79/FluentAdFlowBridge.xcframework.4.1.1-beta.1-rn0.79.zip' }
